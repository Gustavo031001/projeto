    ...
    <html>
        ...
        <body>
            ...
            <form action="atualiza_cliente.php" method="post">
                ...
                Telefone:<input type="text" name="txtTelefone" value="<?php print($cliente['telefone'])?>"><br/>
                Endereço:<input type="text" name="txtEndereco" value="<?php print($cliente['endereco'])?>"><br/>
